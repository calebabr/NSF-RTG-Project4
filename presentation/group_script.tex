...
All scripts, data, and figures from this project are publicly available at:

\begin{center}
  \texttt{https://github.com/calebabr/NSF-RTG-Project4}
\end{center}

The \texttt{README} contains full documentation of every script, experiment design, parameter choices, and result tables, including entries not shown in this presentation.
It is available directly at:

\begin{center}
  \texttt{https://github.com/calebabr/NSF-RTG-Project4/blob/main/README.md}
\end{center}
